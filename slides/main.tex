...
\node[black!60] (testtest) {$\displaystyle{\visible<6->{\Vol_{\widetilde M}(s)=\int_{\str_n(s)}\omega_{\widetilde M}}}{\visible<8->{\implies\text{è $G$-invariante}}}$};
\end{tikzpicture}
\end{center}
\begin{onslide}<6->
...
{\visible<4->{\lar[visible on=<4->,mapsto]\left[\Vol_{\widetilde M}\right]^G_c}}
\end{diagram}
