...
In questa sezione, tutti moduli di (co)catene e di (co)omologia saranno da intendersi a coefficienti in $\RR$. \todo{Dirlo prima.}
...
\begin{proposition}\thlabel{continuous-cohomology-isomorphism}
