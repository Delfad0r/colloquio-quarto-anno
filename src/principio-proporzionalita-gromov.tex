...
\end{theorem}
\begin{proof}
Possiamo facilmente ridurci al caso in cui $M$ sia orientata. Cominciamo osservando che tutte le mappe nel seguente diagramma sono isomorfismi o immersioni isometriche (rispettivamente per il \thref{continuous-cohomology-isomorphism}, il \thref{continuous-gamma-invariant-cochains} e il \thref{restriction-map-isometric-embedding}).
\begin{diagram}
